...
<body>
  ...
  <div id="wrapper" style="display: flex; flex-direction: row;">
    <div class="sidebar">
      ...
      <a class="active" href="./laporan.php"><i class="fa fa-shopping-cart"></i>  Laporan</a>
...
<hr>
    <table border="1" width="400px" class="table">
       ...
       <tbody>
<?php
//ambil data dari checkout di database
...
while($a=mysqli_fetch_array($ambildata)){
    ?>
       ...
       <td><?php echo $a['id'];?></td>
           ...
           <td>
				<a onclick="alert('Data Berhasil Dihapus!')" class="hapus" href="erase.php?id=<?php echo $a['id']; ?>">Hapus</a>					
</td>
       </tr>
<?php
}
