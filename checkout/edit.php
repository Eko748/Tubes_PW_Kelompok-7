...
<header>
	...
	include "koneksi.php";
	$id = $_GET['id'];
	$query_mysql = mysqli_query($koneksi, "SELECT * FROM checkout WHERE id='$id'")or die(mysqli_error($koneksi));
	$nomor = 1;
	...
	<form action="update.php" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><input type="date" name="tanggal_pemesanan" value="<?php echo $data['tanggal_pemesanan'] ?>"></td>					
			</tr>	
			<tr>
				<td>Tanggal Pengiriman</td>
				<td><input type="date" name="tanggal_pengiriman" value="<?php echo $data['tanggal_pengiriman'] ?>"></td>					
			</tr>	
			<tr>
				<td>No.Hp</td>
            ...
            <td>Nama Item</td>
            <td>
                <select name="nama_item" value="<?php echo $data['nama_item'] ?>" required="">
			...
			<tr>
				<td></td>
				<td><input onclick="alert('Data Berhasil Diubah!')" style="background: #00CC00; padding: 4px" type="submit" value="Simpan"></td>					
			</tr>				
		</table>
		</fieldset>
	</form>
